...
Viewer.prototype.importXML = function(xml, done) {
  ...
  this._moddle.fromXML(xml, 'bpmn:Definitions', function(err, definitions, context) {
    ...
    for (var i = 0; i < flows.length; i++) {
      if (flows[i].$type === "bpmn:SequenceFlow" || flows[i].$type === "SequenceFlow"
        || flows[i].$type === "bpmn:StartEvent" || flows[i].$type === "StartEvent"
        || flows[i].$type === "bpmn:EndEvent" || flows[i].$type === "EndEvent") {
        // console.info(fe);
        flows[i].name = "";
      }
    }
